...
Voor het calibreren van een refractometer het zetten van het nulpunt meestal voldoende. Dit doe je door een meting met gedestilleerd (of gedemineraliseerd) water uit te voeren. Gedestilleerd water heeft namelijk een dichtheid van 1000, de Brixwaarde moet dan 0 zijn. Een goede refractometer heeft een stelknop of stelschroef om de schaalaflezing op 0 in te stellen. 
...
```{block2, type = "rmdinfo"}
Je kunt natuurlijk ook metingen uitvoeren met zowel de refractometer en een hydrometer en deze waarden met alkaar vergelijken.

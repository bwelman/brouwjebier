...
```{r schrootmolens, fig.cap="Twee soorten schrootmolens. Links een schijvenmolen en rechts een walsenmolen.", out.width="50%"}
...
```{r brouwketel-kraan, fig.cap="Brouwketel met kraan.", out.width="30%"}
...
```{r gasbrander, fig.cap="Gasbrander", out.width="30%"}
...
```{r wortkoeler, fig.cap="Links een dompelkoeler, rechts een platenkoeler.", out.width="50%"}
...
```{r wortfilter, fig.cap="Wortfilter van koper met hevel.", out.width="30%"}
...
```{r gistvat, fig.cap="Gistvat van kunststof met aftapkraan.", out.width="25%"}
...
```{r waterslot, fig.cap="Waterslot, links een slangmodel, rechts een cylindrische model.", out.width="25%"}
...
```{r hydrometer-aflezing, fig.cap="Hydrometer met bijpassende maatcilinder.", out.width="50%"}
...
```{r kroonkurkapparaat, fig.cap="Kroonkurkapparaat.", out.width="25%"}
...
```{r refractometer, fig.cap="Refractometer en de aflezing daarvan.", out.width="40%"}
...
```{r inkbird, fig.cap="Inkbird ITC-308 temperatuurregelaar.", out.width="30%"}

...
knitr::include_graphics("images/brouwketel-kraan.jpg")
```
...
knitr::include_graphics("images/gistvat.jpg")
```
...
::: {.info data-latex=""}
In plaats van een hydrometer kun je ook een refractometer gebruiken. Hiervoor heb je maar een paar druppeltjes vloeistof nodig.
:::
...
knitr::include_graphics("images/kroonkurkapparaat.jpg")
```

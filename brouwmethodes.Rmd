...
```{r biab, echo=FALSE, fig.cap="BIAB - Brouwen in een zak.", out.width="40%"}
...
```{r rims, echo=FALSE, fig.cap="RIMS - schematische weergave.", out.width="40%"}

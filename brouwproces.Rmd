...
```{r brouwproces, fig.cap="Het brouwproces in grote lijnen.", out.width="100%"}
grViz(diagram = "diagrammen/brouwproces.gv", height = 50)
```
...
```{r moutsoorten, fig.cap="Drie moutsoorten: van een donkere kleur naar een lichtere kleur.", out.width="40%"}
...
```{r schrootsel, fig.cap="Mooi schrootsel, niet te fijn.", out.width="40%"}
...
```{r jodiumtest, fig.cap="Jodiumtest: Links blauwe kleur, nog zetmeel aanwezig. Rechts bruine kleur, geen zetmeel meer aanwezig.", out.width="40%"}

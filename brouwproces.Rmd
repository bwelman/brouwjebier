...
```{r brouwproces, fig.cap="Het brouwproces in grote lijnen.", echo=FALSE}
knitr::include_graphics("images/brouwproces.png", dpi = NA)
```
...
Tijdens het maischen gaan verschillende enzymen aan het werk. Een bepaald enzym werkt het beste bij een bepaalde temperatuur en zuurgraad (pH) van de maisch. Over deze processen wordt in hoofdstuk \@ref(maischen) uitvoeriger ingegaan. Het beslag ga je onder rustig roeren opwarmen tot de temperatuur waarbij de enzymen het beste werken. En die temperatuur wordt dan een tijdje aan gehouden, het beslag krijgt een **rust**. Daarna wordt er opgewarmd tot een volgende temperatuur waarbij andere enzymen het beste werken en krijgt het beslag ook een bepaalde **rusttijd**. De verschillende temperaturen waarbij gerust wordt heet **maischschema**.
...
De wort gaat nu minstens een uur gekookt worden. Tijdens het koken gaat er hop toegevoegd worden. In het recept staat weer hoe lang de *kooktijd* is en hoeveel gram van welke *hop* hoe lang moet meekoken. Zorg voor een zogenaamde "rollende kook".
...
Om er voor te zorgen dat de bottelsuiker goed vergist wordt, dus ook in alkohol en koolzuurgas wordt omgezet, moet je de flessen een kleine week op kamertemperatuur wegzetten. Het koolzuurgas kan niet uit de afgesloten fles ontsnappen en lost op in de vloeistof.

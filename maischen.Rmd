...
mono %>% kbl(caption = "Substraten en hun splitsingsenzymen") %>% kable_styling()
```
...
|                  |Eiwitrust       |Maltoserust             |Versuikeringsrust       |
|:-----------------|:---------------|:-----------------------|:-----------------------|
...
|------------------|----------------|------------------------|------------------------|
|lagere temp.      |\+ klaring      |\+ vergistingsgraad     |\+ vergistingsgraad     |
|                  |\- schuim       |\- onvergistbare suikers|\- onvergistbare suikers|
|                  |\- volmondigheid|                        |                        |
|hogere temp.      |\- klaring      |\- vergistingsgraad     |\- vergistingsgraad     |
|                  |\+ schuim       |\+ onvergistbare suikers|\+ onvergistbare suikers|
|                  |\+ volmondigheid|                        |                        |

|Rusttijd (min.)   |10-30           |15-45                   |15-45                   |
|------------------|----------------|------------------------|------------------------|
|kortere tijd      |\+ klaring      |\- vergistingsgraad     |\- vergistingsgraad     |
|                  |\+ schuim       |\+ onvergistbare suikers|\+ onvergistbare suikers|
|                  |\- volmondigheid|                        |                        |
|langere tijd      |\- klaring      |\+ vergistingsgraad     |\+ vergistingsgraad     |
|                  |\+ schuim       |\- onvergistbare suikers|\- onvergistbare suikers|
|                  |\- volmondigheid|                        |                        |

```{r infusie-3staps, echo=FALSE, fig.align="center", out.width="70%", fig.cap="Voorbeeld maischstappen in een infusieproces"}
...
infusieplot <- ggplot(data = infusie3, aes( x = tijd, y = temp, label=temp)) +
	...
	theme_bw() +
	scale_x_continuous(breaks = seq(0,150,10)) + scale_y_continuous(breaks = seq(0,90,10)) +

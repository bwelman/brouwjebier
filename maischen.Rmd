...
mono %>% 
	kbl(caption = "Substraten en hun splitsingsenzymen") %>% 
...
```{r enzymactiviteit, fig.cap="Verband tussen enzymactiviteit en temperatuur", out.width="40%"}
...
```{r maischtabel, fig.cap="Overzicht maischstappen, enzymen, pH en invloed temperatuur en rusttijd.", out.width="100%"}
...
```{r infusie-3staps, fig.cap="Voorbeeld maischstappen in een infusieproces", out.width="100%"}

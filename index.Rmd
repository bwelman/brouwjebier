...
meta() %>%
	meta_description("Cursus bierbrouwen voor beginners") %>%
	meta_name("keywords" = "tutorial, cursus, studieboek, brouwcursus, bier, brouwen, bierbrouwen") %>%
	meta_general() %>%
	meta_social(
		title = "Cursus bierbrouwen voor beginners",
		url = "https://brouwjebier.nu/",
		image = "https://brouwjebier.nu/images/cover.png",
		og_type = "book",

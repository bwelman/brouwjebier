...
Volgens het [Bier Keurmeesters Gilde](https://www.bierkeurmeestersgilde.nl){target="_blank"}

## Biertypenlijst {#biertype-tabel}

```{r bkg-tabel, echo=FALSE}
# Tabel met klassen als kolommen
load(file = 'resources/bkgtabel.rda')

bkg.tabel %>%
	kbl(caption = "Tabel biertypen volgens BKG (versie 2.4, Juli 2021)", position = "!ht") %>%

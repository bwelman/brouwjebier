...
```{r schoonmaakmiddelen, fig.cap="Van links naar rechts: (neutraal) afwasmiddel, oxi, enzybrew.", out.width="40%"}
...
```{r desinfectiemiddelen, fig.cap="Destinfectiemiddelen: Starsan en Chemipro Oxi", out.width="25%"}

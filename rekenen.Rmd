...
Gebruik tabel \@ref(tab:tabel-dhr-simpel) voor een ruwe schatting van het digitaal hoprendement (DHR).

Table: (\#tab:tabel-dhr-simpel) Schatting DHR-waarde op basis van kooktijd

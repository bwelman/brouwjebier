...
-  Enige kennis hebben van de invloed van de watersamenstelling op het bier.
-  Weten welke rol de pH waarde vervult bij het brouwproces.
-  Weten hoe je de pH kunt meten en de waarde kunt wijzigen.
-  Weten wat de rol van zouten in het brouwwater is.
-  Weten wat je met brouwzouten kunt doen.
...
Voor het brouwen van bier is de kwaliteit en samenstelling van het brouwwater van belang. Grote brouwerijen hebben vaak hub eigen waterbronnen. De anderen doen het met kraanwater. Zo bevat het water in de Achterhoek meer mineralen (is harder) dan het water in Zuid-Limburg. Ook voor het maken van bepaalde biertypes is dit van belang. Twee bekende plaatsen in deze zijn
...
Vooral bij het maischen speelt de pH een belangrijke rol. De enzymen is werken het beste bij een pH van 5,2-5,6. Ook bij het koken met hop verloopt het extraheren van de bitterstoffen uit de hop het beste in dit pH waardengebied.
...
Het goedkoopst kun je de pH meten met pH strips. Deze zijn te koop voor verschillende pH gebieden. Het beste kun je twee soorten kopen, eentje voor het pH bereik 5,2-6,8 en eentje voor het bereik 3,8-5,5. Ze zien in verschillende uitvoeringen te koop, zie o.a. figuur \@ref(fig:ph38-55).

```{r ph38-55, fig.cap="pH strip voor het bereik 3,8-5,5.", echo=FALSE}
knitr::include_graphics("images/ph38-55.png", dpi = NA)
```
...
Het gebruik van pH papier is geen erg nauwkeurige methode, maar voor de hobbybrouwer vaak voldoende. Het gaat er immers om dat je in het pH gebied 5,3-5,5 zit. Wil je een nauwkeuriger waarde dan moet je een pH meter aanschaffen. Deze is niet alleen duurder maar vereist ook regelmatige calibratie.
...
```{block2, type = "rmdtip"}
Wanneer je over de watersamenstelling van het drinkwaterbedrijf beschikt kun je ook redelijk goed de pH van het brouwsel vooraf berekenen met brouwsoftware (o.a. het gratis Brouwhulp).
...
-  Calcium, Magnesium en Waterstofcarbonaat: verantwoordelijk voor de hardheid van het water (uitgedrukt in graden Duitse Hardheid).
...
Voor invloed op de smaak is vooral de onderlinge verhouding Chloride en Sulfaat van belang. Als deze onderlinge verhouding klein is, accentueert dit de bitterheid, van belang voor bijvoorbeeld een IPA. Een hogere onderlinge verhouding levert een accentuering van zoetheid op.

Wanneer het water te hard is voor het te brouwen biertype, dan kun je tijdelijke hardheid, veroorzaakt door waterstofcarbonaat, verminderen door het vooraf te koken. Daarna moet je het uiteraard weer afkoelen tot de inmaischtemperatuur.

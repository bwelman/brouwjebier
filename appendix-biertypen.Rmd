...
# Bijlage Biertypen {#bijlage-biertypen}

Volgens het [BierKeurmeestersGilde](https://www.bierkeurmeestersgilde.nl){target="_blank"}

## Biertypenlijst {#biertype-lijst}

```{r echo=FALSE}
bt <- read_delim("S:/websites/vlearmoesbier/static/download/bkg_biertypen.csv", 
				 ";", escape_double = FALSE, locale = locale(decimal_mark = ","),
				 trim_ws = TRUE) %>% select(BIERTYPE, KLASSE)
...
knitr::kable(tabel) %>% 
	kable_styling(font_size = 11, full_width=FALSE, latex_options = "scale_down", bootstrap_options = "responsive")
```

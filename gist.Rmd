...
```{r gistafbeelding, fig.cap="Microscopisch beeld van een droge bovengist (bron Fermentis).", out.width="40%"}
...
```{r krausen, fig.cap="Gistend bier met Krausen.", out.width="30%"}
...
```{r giststarter, fig.cap="Giststarter op magneetroerder", out.width="30%"}

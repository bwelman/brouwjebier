...
df %>% 
	kbl(caption = "Ervaringen bitterheid") %>%
...
```{r hop-bloemen-pellets, fig.cap="Hop: pellets en bloemen", out.width="40%"}
...
```{r ihop-zakje-spider, fig.cap="Links een hopzakje, rechts een hopspider.", out.width="40%"}
...
```{r hoprendement-kooktijd, fig.cap="Effect kooktijd op bitterheid (volgens Tinseth voor een begin SG van 1050", out.width="80%"}

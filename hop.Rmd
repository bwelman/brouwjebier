...
```{r hoprendement-kooktijd, echo=FALSE, fig.align="center", out.width="70%", fig.cap="Effect kooktijd op bitterheid (volgens Tinseth voor een begin SG van 1050"}

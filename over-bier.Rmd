...
```{r bier-me, echo=FALSE, out.width="40%", fig.cap="Bier in de Middeleeuwen"}
...
```{r reinheitsgebot, echo=FALSE, out.width="50%", fig.cap="Het Reinheitsgebot kort en krachtig."}
knitr::include_graphics("images/reinheitsgebot.jpg")
```
...
Vóór 1840 waren alle bieren bovengistend. De vergisting hiervan vindt bij relatief hoge temperaturen (15 à 20 ^o^C) plaats en de gist stijgt naar de oppervlakte.
